...
Корпус моделювався у програмі Fusion360, у папці [3D models][1] розміщений файл проекту [f3z][2] та [STL][3] файли для друку. Файли рекомендовано використовувати з папки [V1.1(Latest)][4] оскільки це остання версія де виправлені деякі дрібні недоліки.
